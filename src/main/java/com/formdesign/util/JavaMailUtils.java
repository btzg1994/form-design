...
public class JavaMailUtils {
    ...
    public static void main(String[] args) {
        // 您要发送给谁，标题，内容
        JavaMailUtils.send("2814985539@qq.com", "标题", "内容");
    }
    
    /**
     * 
     * @param toUserEmailAddr 接收者邮箱
     * @param title 邮件标题
     * @param content 内容
     */
    public static void send(String toUserEmailAddr,String title,String content){
    	 JavaMailUtils.send(toUserEmailAddr, title, content, "smtp", "smtp.qq.com", username, "8888", username, password);
    }
    
    private static String username = "302720964@qq.com";
    private static String password = "bboagtphuvmpbiad";
