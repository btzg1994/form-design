    ...
    <div class="content-box">
      ...
      <!--左边导航-->
    		<jsp:include page="../public/content_left.jsp">
    			<jsp:param value="activityList" name="type"/>
    		</jsp:include>  	
			<!--左边导航结束-->
									...
									<tr>
										...
										<td>
											<c:if test="${activity.status == 1}">
												<a class="frozenBtn" href="javascript:frozen('${pageContext.request.contextPath}/sign/activity/frozen?id=${activity.id}');">冻结</a>&nbsp;&nbsp;
											</c:if>
											<c:if test="${activity.status == 0}">
												<a class="activeBtn" href="javascript:active('${pageContext.request.contextPath}/sign/activity/active?id=${activity.id}');">启用</a>&nbsp;&nbsp;
											</c:if>
												<a  href="${pageContext.request.contextPath}/sign/activity/findActivityById?id=${activity.id}">编辑</a>&nbsp;&nbsp;
