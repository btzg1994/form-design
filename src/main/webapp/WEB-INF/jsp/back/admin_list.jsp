    ...
    <div class="content-box">
     <!--左边导航-->
    		<jsp:include page="../public/content_left.jsp">
    			<jsp:param value="adminList" name="type"/>
    		</jsp:include>  	
			<!--左边导航结束-->
			...
			<div class="content-rg">
             ...
             <div class="rgtit">
                <ul>
                    <li class="sele"><span>管理人员查询</span></li>
                </ul>
                <div class="clear"></div>
            </div>
				...
				<div class="rgcon bodybai">
					<div class="col-md-6">
						<form class="form-horizontal">
						    <div class="col-md-4">
						    	<input type="tel" maxlength="11" class="form-control"  name="adminName" id="adminName" value="" placeholder="登录名">
						    </div>
						    <div class="col-md-4">
					...
					<div class="col-md-5">
						<div class="col-md-6">
							<a  id="searchBtn" href="javascript:renderByUrl('${pageContext.request.contextPath}/admin/findAdminByPage/1/10');" class="btn btn-info" >查询</a>
...
<script type="text/javascript">
	$(function(){
		/* 进入页面初始化数据 */		
		renderByUrl("${pageContext.request.contextPath}/admin/findAdminByPage/1/10");
	...
	function renderByUrl(url){
		...
		var name = $('#name').val();
		var params = "?adminName=" + adminName +"&gender=" + gender+"&name=" + name;
		url = url + params;
	...
	function renderByJson(pageInfo){
		...
		pageInfo.baseUrl = "${pageContext.request.contextPath}/admin/findAdminByPage";
...
<script type="text/html" id="data_tpl">
								{{each list as l i}}
									<tr>
										...
										<td>{{l.createTime}}</td>
										<td>
											<a href="javascript:deleteAdmin('{{l.id}}');">删除</a>
										</td>
									</tr>
								{{/each}}
